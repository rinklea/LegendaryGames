...
function Board:initializeTiles()
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            table.insert(self.tiles[tileY],Tiles(tileX, tileY, math.random(18), math.random(math.min(6,level))))
        end
    end
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                if level>=2 then
					self.variety=math.random(4)
				end
				
				local tile = Tiles(x, y, math.random(18), self.variety)
